...
public class AllConfig {
    public static final String cron = "0 0 6 * * ?"; //分别代表：秒、分、时、日、月、星期
    ...
    private static void init(){
        ...
        userList.add(getUser(
                ...
                "HkFpObOVrxBGmdwzpMqYthH8FURcCJvU2kqD_yW7zEs", //要给这个人发送的模板ID
                "十九", //咋称呼这个人
                "河北省保定市定州市", //这个人的详细地址
                "定州市", //这个人在的城市
                new BirthDay(2002,10,3,false,false)//分别代表年、月、日、是否是农历(true为农历、false为公历)、是否统计天数(true为统计，false为倒计时)
        ));
